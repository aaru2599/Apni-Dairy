    ...
    return (
        <section style={{ display: "flex", marginTop: "100px"}}>
            <div style={{ width: "50%", height: "90vh", }}>
                ...
                <div>
                    <div>
                        <img src="src/assets/sec1-img.png" alt="" />
                    </div>
                </div>
            </div>
            <div style={{ width: "50%" }}>
                    ...
                    <section>
                        <div className='position-relative'>
                            ...
                            <div style={{ position: "absolute", top: "-30px", left: "-110px" }}>
                                <img src="src/assets/cow-head.png" className='position-absolute' width={100} alt="" />
                    ...
                    <section style={{ position: "relative" }}>
                        <div className='bg-warning d-flex justify-content-around' style={{ height: "250px", position: "absolute", width: "600px", bottom: "-300px" }}>
                            <div className='d-flex flex-row align-items-center'>
                                <div><img src="src/assets/goat-white.png" alt="" /></div>
                            ...
                            <div className='d-flex flex-row align-items-center'>
                                <div><img src="src/assets/cow-white.png" alt="" /></div>
                                <div className='text-light'>
